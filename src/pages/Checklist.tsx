          ...
          <div className="flex flex-wrap gap-2 mb-6">
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-sm ${
                selectedCategory === "Tất cả" ? "bg-sky-500 text-white" : "bg-white border border-slate-200"
              }`}
            >
            ...
            {categories.map(cat => (
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-sm ${
                  selectedCategory === cat ? "bg-sky-500 text-white" : "bg-white border border-slate-200"
                }`}
              >
